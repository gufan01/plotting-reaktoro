...
folder_general = "results-smart-kin-smart-eq-figures" + folder + tag_smart

folder_general = "results-smart-kinetics-smart-equlibrium-videos-" + result_tag + folder + tag_smart
...
def plot_animation_ph():
    ...
    anim.save(folder_general + '/pH-' + result_tag + '.mp4', fps=animation_fps, extra_args=['-vcodec', 'libx264'])
...
def plot_animation_calcite_dolomite():
    ...
    anim.save(folder_general + '/calcite-dolomite-' + result_tag + '.mp4', fps=animation_fps, extra_args=['-vcodec', 'libx264'])
...
def plot_animation_aqueous_species():
    ...
    anim.save(folder_general + '/aqueous-species-' + result_tag + '.mp4', fps=animation_fps, extra_args=['-vcodec', 'libx264'])
