...
#result_folder = 'results-pitzer-long-videos'
...
result_folder = 'results-pitzer-short-videos'
...
test_tag_smart = tag_smart + "-smart"
...
def plot_animation_ph():
    ...
    anim.save(result_folder + '/pH.mp4', fps=animation_fps, extra_args=['-vcodec', 'libx264'])
...
def plot_animation_calcite_dolomite():
    ...
    anim.save(result_folder + '/calcite-dolomite.mp4', fps=animation_fps, extra_args=['-vcodec', 'libx264'])
...
def plot_animation_aqueous_species():
    ...
    anim.save(result_folder + '/aqueous-species.mp4', fps=animation_fps, extra_args=['-vcodec', 'libx264'])
...
if __name__ == '__main__':
    ...
    status_learnings = status_data.get('smart_equilibrium_cells_where_learning_was_required_at_step')
