...
#folder_smart   = "results-custering-primary-species-paper-dt-1800-ncells-100-nsteps-10000-reltol-1.0e-03-hkf-full-smart"
#folder_class   = "results-custering-primary-species-paper-dt-1800-ncells-100-nsteps-10000-hkf-full-reference"
#folder_general = "plots-results-custering-primary-species-paper-dt-1800-ncells-100-nsteps-10000-reltol-1.0e-03-hkf-full-smart"
...
def plot_figures_log10_aqueous_species():
    ...
    for i in plot_at_selected_steps:
        ...
        plt.savefig(folder_general + '/aqueous-species-log10-{}.png'.format(i))
        plt.tight_layout()
        plt.close()
...
def plot_on_demand_learnings_total_initial_steps(nsteps_initial):
    ...
    plt.tight_layout()
    plt.savefig(folder_general + '/on-demand-learning-total-initial-steps-'+ str(nsteps_initial) + '.png')
    plt.close()
...
def plot_computing_costs_vs_total_learnings():
    ...
    timings_search = np.array(timing_smart.get('smart_equilibrium_search')) * 1e6  # in microseconds`
...
def plot_speedups():
    ...
    speedup_ideal = np.array(timing_class.get('equilibrium')) / \
                    (np.array(timing_smart.get('smart_equilibrium')) \
                     ...
                     - np.array(timing_smart.get('smart_equilibrium_database_priority_update')) \
...
def calculate_error(tol):
    ...
    #for i in [1, 20, 2400]:
        ...
        plt.legend(loc='center right')
        plt.savefig(folder_general + f'/error-rel-calcite-dolomite-short-{i}.png')
        plt.tight_layout()
        plt.close()
        ...
        plt.savefig(folder_general + f'/error-rel-aqueous-species-short-{i}.png')
        plt.tight_layout()
        plt.close()
        '''
        '''
...
def plot_animation_calcite_dolomite():
    ...
    bar = IncrementalBar('On calcite-dolomite animation:', max = len(animation_frame_range))
...
def plot_animation_aqueous_species():
    ...
    ax.set_title(titlestr(0.0))
    objects = [
        ax.plot([], [], label=r'$Ca^{2+}$', **line('C0'))[0],
        ax.plot([], [], label=r'$Mg^{2+}$', **line('C1'))[0],
        ax.plot([], [], label=r'$HCO_3^{-}$',**line('C2'))[0],
        ax.plot([], [], label=r'$CO_2(aq)$',**line('C3'))[0],
        ax.plot([], [], label=r'$H^+$', **line('C4'))[0],
        ax.plot([], [], label=r'$CO_3^{2-}$', **line('C5'))[0],
        ax.plot([], [], label=r'$Ca(HCO_3)^+$', **line('C6'))[0],
        ax.plot([], [], label=r'$CaCl^+$',**line('C7'))[0],
        ax.plot([], [], label=r'$MgCl^+$',**line('C8'))[0],
        ax.plot([], [], label=r'$Mg(HCO_3))^+$',**line('C9'))[0],
        ax.plot([], [], label=r'$OH^-$', **line('darkviolet'))[0],
        ax.plot([], [], 'o', **line_empty_marker('C0'))[0],
        ax.plot([], [], 'o', **line_filled_marker('C0'))[0],
        ax.plot([], [], 'o', **line_empty_marker('C1'))[0],
        ax.plot([], [], 'o', **line_filled_marker('C1'))[0],
        ...
        ax.plot([], [], 'o', **line_empty_marker('C3'))[0],
        ax.plot([], [], 'o', **line_filled_marker('C3'))[0],
        ax.plot([], [], 'o', **line_empty_marker('C4'))[0],
        ax.plot([], [], 'o', **line_filled_marker('C4'))[0],
        ax.plot([], [], 'o', **line_empty_marker('C5'))[0],
        ax.plot([], [], 'o', **line_filled_marker('C5'))[0],
        ax.plot([], [], 'o', **line_empty_marker('C6'))[0],
        ax.plot([], [], 'o', **line_filled_marker('C6'))[0],
        ax.plot([], [], 'o', **line_empty_marker('C7'))[0],
        ax.plot([], [], 'o', **line_filled_marker('C7'))[0],
        ax.plot([], [], 'o', **line_empty_marker('C8'))[0],
        ax.plot([], [], 'o', **line_filled_marker('C8'))[0],
        ax.plot([], [], 'o', **line_empty_marker('C9'))[0],
        ax.plot([], [], 'o', **line_filled_marker('C9'))[0],
    ...
    def animate(i):
        ...
        objects[5].set_data(xcells, data_class_CO3anion)
        objects[6].set_data(xcells, data_class_CaHCO3cation)
        objects[7].set_data(xcells, data_class_CaClcation)
        objects[8].set_data(xcells, data_class_MgClcation)
        objects[9].set_data(xcells, data_class_MgHCO3caanion)
        objects[10].set_data(xcells, data_class_OHanion)

        objects[11].set_data(xcells[status[i]==0], data_smart_cacation[status[i]==0])
        objects[12].set_data(xcells[status[i]==1], data_smart_cacation[status[i]==1])

        objects[13].set_data(xcells[status[i]==0], data_smart_mgcation[status[i]==0])
        objects[14].set_data(xcells[status[i]==1], data_smart_mgcation[status[i]==1])

        objects[15].set_data(xcells[status[i]==0], data_smart_hco3anion[status[i]==0])
        objects[16].set_data(xcells[status[i]==1], data_smart_hco3anion[status[i]==1])

        objects[17].set_data(xcells[status[i]==0], data_smart_co2aq[status[i]==0])
        objects[18].set_data(xcells[status[i]==1], data_smart_co2aq[status[i]==1])

        objects[19].set_data(xcells[status[i]==0], data_smart_hcation[status[i]==0])
        objects[20].set_data(xcells[status[i]==1], data_smart_hcation[status[i]==1])

        objects[21].set_data(xcells[status[i]==0], data_smart_CO3anion[status[i]==0])
        objects[22].set_data(xcells[status[i]==1], data_smart_CO3anion[status[i]==1])

        objects[23].set_data(xcells[status[i]==0], data_smart_CaHCO3cation[status[i]==0])
        objects[24].set_data(xcells[status[i]==1], data_smart_CaHCO3cation[status[i]==1])

        objects[25].set_data(xcells[status[i]==0], data_smart_CaClcation[status[i]==0])
        objects[26].set_data(xcells[status[i]==1], data_smart_CaClcation[status[i]==1])

        objects[27].set_data(xcells[status[i]==0], data_smart_MgClcation[status[i]==0])
        objects[28].set_data(xcells[status[i]==1], data_smart_MgClcation[status[i]==1])

        objects[29].set_data(xcells[status[i]==0], data_smart_MgHCO3caanion[status[i]==0])
        objects[30].set_data(xcells[status[i]==1], data_smart_MgHCO3caanion[status[i]==1])

        objects[31].set_data(xcells[status[i]==0], data_smart_OHanion[status[i]==0])
        objects[32].set_data(xcells[status[i]==1], data_smart_OHanion[status[i]==1])
...
if __name__ == '__main__':
    ...
    animation_ends_at_frame = 10 * 1000  # the last frame index to be considered
